...
export class WebhookApi extends runtime.BaseAPI {
  /**
   */
  async webhookPostRaw(
    requestParameters: WebhookPostOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<WebhookPost200Response>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      WebhookPost200ResponseFromJSON(jsonValue),
    );
  }
  ...
  async webhookPost(
    requestParameters: WebhookPostOperationRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<WebhookPost200Response> {
    const response = await this.webhookPostRaw(
      requestParameters,
      initOverrides,
    );
