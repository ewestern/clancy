...
export class AgentsApi extends runtime.BaseAPI {
   ...
   * List agents
   */
  async v1AgentsGetRaw(
    requestParameters: V1AgentsGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<Agent>>> {
  ...
  async v1AgentsGet(
    ...
    const response = await this.v1AgentsGetRaw(
      requestParameters,
      initOverrides,
    );
   ...
   * Delete an agent
   */
  async v1AgentsIdDeleteRaw(
    requestParameters: V1AgentsIdDeleteRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
   ...
   * Get an agent
   */
  async v1AgentsIdGetRaw(
    requestParameters: V1AgentsIdGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ...
  async v1AgentsIdGet(
    ...
    const response = await this.v1AgentsIdGetRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   * Update an agent
   */
  async v1AgentsIdPutRaw(
    requestParameters: V1AgentsIdPutOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Agent>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: V1AgentsIdPutRequestToJSON(
          requestParameters["v1AgentsIdPutRequest"],
        ),
      },
      initOverrides,
    );
  ...
  async v1AgentsIdPut(
    ...
    const response = await this.v1AgentsIdPutRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   * Create an agent
   */
  async v1AgentsPostRaw(
    requestParameters: V1AgentsPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Agent>> {
    const queryParameters: any = {};
  ...
  async v1AgentsPost(
    ...
    const response = await this.v1AgentsPostRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
