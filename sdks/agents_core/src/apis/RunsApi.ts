...
export class RunsApi extends runtime.BaseAPI {
   ...
   */
  async v1RunsEventsGetRaw(
    requestParameters: V1RunsEventsGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<ActivityEvent>>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(ActivityEventFromJSON),
    );
  }
   ...
   * List run events for activity log
   */
  async v1RunsEventsGet(
    requestParameters: V1RunsEventsGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Array<ActivityEvent>> {
    const response = await this.v1RunsEventsGetRaw(
      requestParameters,
      initOverrides,
    );
   ...
   */
  async v1RunsGetRaw(
    requestParameters: V1RunsGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
   ...
   * Get a run by ID
   */
  async v1RunsIdGetRaw(
    requestParameters: V1RunsIdGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ...
  async v1RunsIdGet(
    ...
    const response = await this.v1RunsIdGetRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
