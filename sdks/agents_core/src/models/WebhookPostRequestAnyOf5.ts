...
export type WebhookPostRequestAnyOf5TypeEnum =
  (typeof WebhookPostRequestAnyOf5TypeEnum)[keyof typeof WebhookPostRequestAnyOf5TypeEnum];

/**
 * Check if a given object implements the WebhookPostRequestAnyOf5 interface.
 */
export function instanceOfWebhookPostRequestAnyOf5(
  value: object,
): value is WebhookPostRequestAnyOf5 {
...
export function WebhookPostRequestAnyOf5FromJSON(
  json: any,
): WebhookPostRequestAnyOf5 {
  return WebhookPostRequestAnyOf5FromJSONTyped(json, false);
}

export function WebhookPostRequestAnyOf5FromJSONTyped(
  json: any,
...
export function WebhookPostRequestAnyOf5ToJSON(
  json: any,
): WebhookPostRequestAnyOf5 {
  return WebhookPostRequestAnyOf5ToJSONTyped(json, false);
}

export function WebhookPostRequestAnyOf5ToJSONTyped(
  value?: WebhookPostRequestAnyOf5 | null,
