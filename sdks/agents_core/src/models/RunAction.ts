...
export function instanceOfRunAction(value: object): value is RunAction {
    ...
    if (!('agentRunId' in value) || value['agentRunId'] === undefined) return false;
    if (!('providerId' in value) || value['providerId'] === undefined) return false;
    if (!('capabilityId' in value) || value['capabilityId'] === undefined) return false;
    if (!('formattedRequest' in value) || value['formattedRequest'] === undefined) return false;
...
export function RunActionFromJSONTyped(json: any, ignoreDiscriminator: boolean): RunAction {
    if (json == null) {
        return json;
    }
    return {
...
export function RunActionToJSONTyped(value?: RunAction | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
