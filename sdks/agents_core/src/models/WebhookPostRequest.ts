...
import type { WebhookPostRequestAnyOf5Request } from "./WebhookPostRequestAnyOf5Request.js";
import {
...
} from "./WebhookPostRequestAnyOf5Request.js";
import type { WebhookPostRequestAnyOf10 } from "./WebhookPostRequestAnyOf10.js";
import {
...
} from "./WebhookPostRequestAnyOf10.js";
import type { WebhookPostRequestAnyOf11 } from "./WebhookPostRequestAnyOf11.js";
import {
  WebhookPostRequestAnyOf11FromJSON,
  WebhookPostRequestAnyOf11FromJSONTyped,
  WebhookPostRequestAnyOf11ToJSON,
  WebhookPostRequestAnyOf11ToJSONTyped,
} from "./WebhookPostRequestAnyOf11.js";
...
import type { WebhookPostRequestAnyOf9 } from "./WebhookPostRequestAnyOf9.js";
import {
...
} from "./WebhookPostRequestAnyOf9.js";
...
export type WebhookPostRequestTypeEnum =
  (typeof WebhookPostRequestTypeEnum)[keyof typeof WebhookPostRequestTypeEnum];

/**
 * Check if a given object implements the WebhookPostRequest interface.
 */
export function instanceOfWebhookPostRequest(
  value: object,
): value is WebhookPostRequest {
  if (!("orgId" in value) || value["orgId"] === undefined) return false;
  if (!("type" in value) || value["type"] === undefined) return false;
  if (!("timestamp" in value) || value["timestamp"] === undefined) return false;
  if (!("workflows" in value) || value["workflows"] === undefined) return false;
  if (
    !("unsatisfiedWorkflows" in value) ||
    value["unsatisfiedWorkflows"] === undefined
  )
    return false;
...
export function WebhookPostRequestFromJSONTyped(
  json: any,
  ...
  return {
    ...
    phase:
      json["phase"] == null
        ? undefined
        : WebhookPostRequestAnyOfPhaseFromJSON(json["phase"]),
    workflows: (json["workflows"] as Array<any>).map(
      WebhookPostRequestAnyOfWorkflowsInnerFromJSON,
    ),
    unsatisfiedWorkflows: (json["unsatisfiedWorkflows"] as Array<any>).map(
      WebhookPostRequestAnyOfUnsatisfiedWorkflowsInnerFromJSON,
    ),
    agents: (json["agents"] as Array<any>).map(
      WebhookPostRequestAnyOfAgentsInnerFromJSON,
    ),
    userId: json["userId"],
...
export function WebhookPostRequestToJSONTyped(
  value?: WebhookPostRequest | null,
  ...
  return {
    ...
    workflows: (value["workflows"] as Array<any>).map(
      WebhookPostRequestAnyOfWorkflowsInnerToJSON,
    ),
    unsatisfiedWorkflows: (value["unsatisfiedWorkflows"] as Array<any>).map(
      WebhookPostRequestAnyOfUnsatisfiedWorkflowsInnerToJSON,
    ),
    agents: (value["agents"] as Array<any>).map(
      WebhookPostRequestAnyOfAgentsInnerToJSON,
    ),
    userId: value["userId"],
