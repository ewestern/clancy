...
export type WebhookPostRequestAnyOfTypeEnum =
  (typeof WebhookPostRequestAnyOfTypeEnum)[keyof typeof WebhookPostRequestAnyOfTypeEnum];

/**
 * Check if a given object implements the WebhookPostRequestAnyOf interface.
 */
export function instanceOfWebhookPostRequestAnyOf(
  value: object,
): value is WebhookPostRequestAnyOf {
...
export function WebhookPostRequestAnyOfFromJSON(
  json: any,
): WebhookPostRequestAnyOf {
  return WebhookPostRequestAnyOfFromJSONTyped(json, false);
}

export function WebhookPostRequestAnyOfFromJSONTyped(
  json: any,
...
export function WebhookPostRequestAnyOfToJSON(
  json: any,
): WebhookPostRequestAnyOf {
  return WebhookPostRequestAnyOfToJSONTyped(json, false);
}

export function WebhookPostRequestAnyOfToJSONTyped(
  value?: WebhookPostRequestAnyOf | null,
