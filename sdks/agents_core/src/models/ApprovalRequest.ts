...
export type ApprovalRequestStatusEnum =
  (typeof ApprovalRequestStatusEnum)[keyof typeof ApprovalRequestStatusEnum];
...
export function instanceOfApprovalRequest(
  ...
  if (!("modifications" in value) || value["modifications"] === undefined)
    return false;
...
export function ApprovalRequestToJSONTyped(
  value?: Omit<ApprovalRequest, "id" | "createdAt" | "updatedAt"> | null,
