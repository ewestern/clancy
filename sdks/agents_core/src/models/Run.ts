...
export function instanceOfRun(value: object): value is Run {
    ...
    if (!('runStartedAt' in value) || value['runStartedAt'] === undefined) return false;
    return true;
}
...
export function RunFromJSONTyped(json: any, ignoreDiscriminator: boolean): Run {
    ...
    return {
        ...
        'runCompletedAt': json['runCompletedAt'] == null ? undefined : (new Date(json['runCompletedAt'])),
        'actions': json['actions'] == null ? undefined : ((json['actions'] as Array<any>).map(RunActionFromJSON)),
    };
}
...
export function RunToJSONTyped(value?: Run | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'runCompletedAt': value['runCompletedAt'] == null ? undefined : ((value['runCompletedAt']).toISOString()),
        'actions': value['actions'] == null ? undefined : ((value['actions'] as Array<any>).map(RunActionToJSON)),
    };
}
