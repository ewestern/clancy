...
import { GraphType, StringEnum, UnionOneOf } from "../schemas";
...
export const EventSchema = Type.Intersect([UnionOneOf([
    GraphDefinedSchema,
...
export type ExternalIngestionCompleted = Static<typeof ExternalIngestionCompletedSchema>;
