...
export const multiAgentSystems = pgTable(
  "multi_agent_systems",
  {
...
export const promptExecutions = pgTable(
  ...
  (table) => ({
    promptVersionIndex: index("prompt_executions_prompt_version_idx").on(
      table.promptId,
      table.version,
    ),
    timestampIndex: index("prompt_executions_timestamp_idx").on(
      table.timestamp,
    ),
...
export const promptVersions = pgTable(
  ...
  (table) => ({
    promptVersionIndex: index("prompt_versions_prompt_version_idx").on(
      table.promptId,
      table.version,
    ),
    activeIndex: index("prompt_versions_active_idx").on(
      table.promptId,
      table.isActive,
    ),
  }),
